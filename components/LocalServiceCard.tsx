...
export const LocalServiceCard: React.FC<LocalServiceCardProps> = ({
  ...
  return (
    <div className="  border-[2px] border-[#caccce] border-dotted p-4 space-y-2 mb-4 w-full lg:max-w-[410px] text-left">
      <h3 className="text-white space-x-2 ">
        <span className="text-primary-foreground font-semibold">Name:</span>{" "}
        {name}
      </h3>
      <p className="text-white  space-x-2">
        <span className="text-primary-foreground font-semibold">Address:</span>{" "}
        {address}
      </p>
      <p className="text-white  space-x-2">
        <span className="text-primary-foreground font-semibold">Rating:</span>{" "}
      ...
      <Booking
        mapLink={`https://www.google.com/maps/place/?q=place_id:${place_id}`}
